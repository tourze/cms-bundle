...
class RenderTemplate implements \Stringable, Itemable
{
    ...
    public function addChild(RenderTemplate $child): self
    {
    ...
    public function removeChild(RenderTemplate $child): self
    {
